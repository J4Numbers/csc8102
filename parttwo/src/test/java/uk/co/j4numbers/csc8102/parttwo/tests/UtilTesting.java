package uk.co.j4numbers.csc8102.parttwo.tests;
...
import uk.co.j4numbers.csc8102.parttwo.Utils;

/**
 * Class Name - UtilTesting
 * Package - uk.co.j4numbers.parttwo.tests
...
public class UtilTesting {
    ...
    {
        String[] hex_strings = new String[2];
        hex_strings[0] = "0001020304050607";
        ...
        {
            Assert.assertArrayEquals(test_bytes[i], actual_bytes[i]);
        }
    }
